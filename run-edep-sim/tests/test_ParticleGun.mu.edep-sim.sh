...
export ARCUBE_LOGDIR_BASE='/pscratch/sd/t/tta20/Particle_Gun2/test1/logs'
export ARCUBE_OUTDIR_BASE='/pscratch/sd/t/tta20/Particle_Gun2/test1/output'
export ARCUBE_RUNTIME='SHIFTER'
export ARCUBE_BEAM_TYPE='particle_gun'
export ARCUBE_EXPOSURE='100'
